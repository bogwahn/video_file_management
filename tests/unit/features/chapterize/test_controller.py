...
from video_file_management.chapterize.interfaces import UserPromptStrategy, VideoDiscoveryStrategy
...
class MockWriter:
    def __init__(self):
        ...
        self.written_marks: list[VideoMark] | None = None
...
def test_controller_writes_directly_if_no_existing_chapters(new_marks):
    ...
    assert writer.written_marks is not None
